...
std::shared_future<void> PeerConnection::closeAsync() { return impl()->closeAsync(); }

void PeerConnection::closeAsync(std::function<void()> callback) { impl()->closeAsync(std::move(callback)); }
